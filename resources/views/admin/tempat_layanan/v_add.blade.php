...
<div class="col-md-12">
    <div class="card card-outline card-primary">
        ...
        <form action="/tempat_layanan/insert" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="card-body">
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="nama_tempat" class="form-control" placeholder="Nama Tempat">
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <input name="posisi" id="posisi" class="form-control" placeholder="Posisi Tempat">
                            <div class="text-danger">
                                @error('posisi')
                                    {{ $message }}
                                @enderror
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" class="form-control" placeholder="Deskripsi" rows="10"></textarea>
                            <div class="text-danger">
                                @error('deskripsi')
                                    {{ $message }}
                                @enderror
...
<script>
    ...
    var curLocation = [-6.882178649368701, 107.54229120658208];
